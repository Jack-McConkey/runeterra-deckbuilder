...
export default function CardViewer() {
    ...
    const {data} = trpc.relatedCards.useQuery({
        relatedCards: JSON.stringify(cards[showCardDetails]),
    });
    ...
    const preparedRelatedCards = data?.reduce(
        ...
        {[cards[showCardDetails].cardCode]: cards[showCardDetails]} as {
            ...
            {showCardDetails && (
                <Modal style="detailed-card-modal" handleClose={() => setShowCardDetails("")}>
                    <>
                        ...
                        <DetailedRuneterraCard card={cards[showCardDetails]} relatedCards={cards} />
                        <Button
                            isDisabled={false}
                            styling={"close"}
                            handleClick={() => setShowCardDetails("")}>
